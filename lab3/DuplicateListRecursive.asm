...
duplicateLinkedList:
	...
	# Check if the head is copied
	beq $s4, 19, copyTheRest 
	bne $s4, 19, copyTheHead 
...
copyTheRest:
	...
	# Return the duplicated list head
	move $v0, $s3 
